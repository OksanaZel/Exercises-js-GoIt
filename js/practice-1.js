...
// 1. С помощью оператора определения типа убедитесь, что 
//переменные принадлежат типам: string, number, boolean.
...
// const myName = 'Oksana';
// const myAge = 38;
// const myHobby = 'JavaScript';

// let string = `Здравствуйте, меня зовут ${myName}, мне ${myAge} лет и мне нравится ${myHobby}`;
// console.log(string);
...
// age >= min && age <= max ? console.log('Верно'):console.log('Ошибка');
